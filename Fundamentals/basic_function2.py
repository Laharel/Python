...
def countdown(number):
    if (number<0):
        return print("Error number is <0")
    list=[]
...
def print_And_Return (list):
    if (len(list)>2):
        return print("The list is too long.")
    elif (type(list[0])==int and type(list[1])==int):
        print(list[0])
        return list[1]
    else:
        print("The list is not made of numbers")
...
print(first_plus_length([8,2,4,3,9,1,0,6]))
